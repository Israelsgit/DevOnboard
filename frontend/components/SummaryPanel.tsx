    ...
    if (!summary) {
        return (
            <Card className="h-full flex flex-col items-center justify-center p-6 text-center">
                ...
                <Button onClick={onGenerate} disabled={loading} className="bg-purple-600 hover:bg-purple-700">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {summary.tech_stack.map((tech) => (
                                    <span key={tech} className="px-2 py-1 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-md text-xs font-medium border border-purple-100 dark:border-purple-800">
                                        {tech}
                                    </span>
                                ))}
                            </div>
